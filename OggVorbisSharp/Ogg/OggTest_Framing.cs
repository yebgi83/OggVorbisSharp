...
namespace OggVorbisSharp
{
    ...
    static public unsafe class OggTest_Flaming
    {
        ...
        static public void Test()
        {
...

            {
                ...
                /* Test lost pages on pagein/packeetout: no rollback */
                {
                    ...
                    for (int i = 0; i < 5; i++) 
                    {
                        CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[i].header_len), (IntPtr)og[i].header, og[i].header_len);
                        Ogg.ogg_sync_wrote(ref oy, og[i].header_len);
                        
                        CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[i].body_len), (IntPtr)og[i].body, og[i].body_len);
                ...
                /* the rest only test sync */
                {
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)og[1].header, 3);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)(og[1].header + 3), 20);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)(og[1].header + 23), 5);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)(og[1].header + 28), og[1].header_len - 28);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].body_len), (IntPtr)og[1].body, 1000);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].body_len), (IntPtr)(og[1].body + 1000), og[1].body_len - 1000);
                ...
                /* Test fractional page inputs: page + incomplete capture */
                {
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)og[1].header, og[1].header_len);
                    Ogg.ogg_sync_wrote(ref oy, og[1].header_len);
                    
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].body_len), (IntPtr)og[1].body, og[1].body_len);
                    Ogg.ogg_sync_wrote(ref oy, og[1].body_len);
                    
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)og[1].header, 20);
                    Ogg.ogg_sync_wrote(ref oy, 20);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[1].header_len), (IntPtr)(og[1].header + 20), og[1].header_len - 20);
                ...
                /* Test recapture : garbage + page */
                {
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[2].header_len), (IntPtr)og[2].header, 20);
                    Ogg.ogg_sync_wrote(ref oy, 20);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[2].header_len), (IntPtr)(og[2].header + 20), og[2].header_len - 20);
                    Ogg.ogg_sync_wrote(ref oy, og[2].header_len - 20);
                    
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[2].body_len), (IntPtr)og[2].body, og[2].body_len);
                ...
                /* Test recapture: page + garbage + page */
                {
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[2].header_len), (IntPtr)og[2].header, og[2].header_len);
                    ...
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[2].body_len), (IntPtr)og[2].body, og[2].body_len - 5);
                    Ogg.ogg_sync_wrote(ref oy, og[2].body_len - 5);
                    
                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[3].header_len), (IntPtr)og[3].header, og[3].header_len);
                    Ogg.ogg_sync_wrote(ref oy, og[3].header_len);

                    CopyMemory(Ogg.ogg_sync_buffer(ref oy, og[3].body_len), (IntPtr)og[3].body, og[3].body_len);
        ...
        static void copy_page(ref Ogg.ogg_page og)
        {
            ...
            CopyMemory(temp, (IntPtr)og.header, og.header_len);
            og.header = (byte *)temp.ToPointer();

            temp = Marshal.AllocHGlobal(og.body_len);
            CopyMemory(temp, (IntPtr)og.body, og.body_len);
            ...
            for (int i = 0; i < packets; i++) {
                ...
                /* retrive any finished packet */
                {
                    ...
                    while (Ogg.ogg_stream_pageout(ref os_en, ref og) != 0) 
                    {
                        ...
                        {
                            Ogg.ogg_page og_de = default(Ogg.ogg_page);
                            Ogg.ogg_packet op_de = default(Ogg.ogg_packet);
                            Ogg.ogg_packet op_de2 = default(Ogg.ogg_packet);
                            
                            IntPtr buf = Ogg.ogg_sync_buffer(ref oy, og.header_len + og.body_len);
                            IntPtr next = buf;
                            ...
                            {
                                CopyMemory(next, (IntPtr)og.header, byteskipcount - byteskip);
                                next = (IntPtr)(next.ToInt32() + (byteskipcount - byteskip));
                            ...
                            if (byteskipcount > byteskip)
                            {
                                CopyMemory(next, (IntPtr)og.body, byteskipcount - byteskip);
                                next = (IntPtr)(next.ToInt32() + (byteskipcount - byteskip));
                                byteskipcount = byteskip;
                            }
                            
                            Ogg.ogg_sync_wrote(ref oy, next.ToInt32() - buf.ToInt32());
                            ...
                            while(true)
                            {
                                ...
                                {
                                    Ogg.ogg_packet dummy_op = default(Ogg.ogg_packet);
                                    
                                    Ogg.ogg_stream_packetpeek(ref os_de, ref dummy_op);
